...
public class MainActivity extends AppCompatActivity {
    ...
    final String uploadFileName = "28-09-2019-06-12-33.3gp";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /************* Php script path ****************/
        upLoadServerUri = "http://10.208.34.25:9008/upload/";
                ...
                new Thread(new Runnable() {
                    public void run() {
                        runOnUiThread(new Runnable() {
                            public void run() {
                                Toast.makeText(MainActivity.this, "Uploade started", Toast.LENGTH_LONG).show();
                            }
                        });
...
//                                + fileName + """ + lineEnd);
                ...
                Log.e("Upload filception", "Exception : "
                        + e.getMessage(), e);
            }
            dialog.dismiss();
